...
public class GsonHttpMessageConverter extends AbstractHttpMessageConverter<Object> {
  ...
  /**
   * Sets the {@code Gson} for this view. If not set, a default {@link Gson#Gson() Gson} is used.
   * <p>
   * Setting a custom-configured {@code Gson} is one way to take further control of the JSON
